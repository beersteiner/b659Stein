...
static char __pyx_doc_5hello_say_hello_to[] = "say_hello_to(name)";
static PyMethodDef __pyx_mdef_5hello_1say_hello_to = {"say_hello_to", (PyCFunction)__pyx_pw_5hello_1say_hello_to, METH_O, __pyx_doc_5hello_say_hello_to};
